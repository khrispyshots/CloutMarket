...
export const TopAppBar: React.FC<{ onAvatarClick: () => void; onWalletClick: () => void }> = ({ onAvatarClick, onWalletClick }) => {
  ...
  return (
    <header className="bg-clout-bg/92 backdrop-blur-xl fixed top-0 inset-x-0 z-40 border-b border-slate-200 pt-[env(safe-area-inset-top,0px)]">
      <div className="max-w-lg mx-auto w-full h-16 sm:h-20 flex items-center justify-between gap-2 px-3 sm:px-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          <div className="flex items-center rounded-full border border-slate-200 bg-white px-2 py-1 hard-shadow-sm max-w-[4.25rem] sm:max-w-none" title="Clout points (event-driven)">
